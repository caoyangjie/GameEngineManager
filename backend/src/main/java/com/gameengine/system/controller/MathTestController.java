...
public class MathTestController extends BaseController {
    ...
    public AjaxResult saveTestRecord(@RequestBody MathTestRecordDTO recordDTO, HttpServletRequest request) {
        try {
            ...
            MathTestRecordDTO savedRecord = mathTestService.saveTestRecord(recordDTO, userId);
    ...
    public AjaxResult getAllTestRecords(HttpServletRequest request) {
        try {
            ...
            List<MathTestRecordDTO> records = mathTestService.getAllTestRecords(userId);
    ...
    public AjaxResult getTestRecordById(@PathVariable Long id, HttpServletRequest request) {
        try {
            ...
            MathTestRecordDTO record = mathTestService.getTestRecordById(id, userId);
            if (record == null) {
    ...
    public AjaxResult deleteTestRecord(@PathVariable Long id, HttpServletRequest request) {
        try {
            ...
            boolean success = mathTestService.deleteTestRecord(id, userId);
            if (success) {
                return success("删除成功");
            } else {
    ...
    public AjaxResult getTestRecordsPage(
        ...
        try {
            ...
            com.baomidou.mybatisplus.core.metadata.IPage<MathTestRecordDTO> result = 
                mathTestService.getTestRecordsPage(page, studentName, startDate, endDate, minAccuracyRate, maxAccuracyRate, userId);
